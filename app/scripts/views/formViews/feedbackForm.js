define([
    ...
    'views/formViews/people/addDoctor',
    'views/formViews/people/addPatient',
    'views/formViews/people/addPerson',
    'views/formViews/inventoryRequired/addExpInventoryItem',
    'views/formViews/treatments/addTreatmentStage',
    'views/formViews/treatments/addTreatment',

    'views/formViews/revenue/revenueTable',
    'views/formViews/bankDeposits/bankDepositsTable',
    'views/formViews/expenditure/expenditureTable',
    'views/formViews/patientsFeedback/patientsFeedbackTable',
    'views/formViews/clinicIssues/clinicIssuesTable',
    ...
    var FeedbackFormView  = Backbone.View.extend({
        ...
        initialize: function(){
            ...
            this.listenTo(vent,'CDF.Views.Treatments.ConsultationRowView:addNewDoctor', this.displayAddDoctorModal);
            ...
            this.listenTo(vent,'CDF.Views.Treatments.MiscRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.ConsultationRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.CrownNBridgeRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.DenturesRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.ExtractionsRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.FillingsRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.RootCanalRowView:addNewTreatment', this.displayAddTreatmentModal);
            this.listenTo(vent,'CDF.Views.Treatments.PerioRowView:addNewTreatment', this.displayAddTreatmentModal);
        ...
        displayAddTreatmentModal: function(msg){

            var addTreatmentView = new AddTreatmentView();

            addTreatmentView.model.set({
                name: msg.name,
                category: msg.category
            });

            addTreatmentView.callback = msg.callback;
            addTreatmentView.render();
            var modal = new ModalView();
            modal.model.set({header:"Add Treatment",footer:"",body:addTreatmentView.$el});
            this.addAlertView(modal);
            modal.show();
        },
