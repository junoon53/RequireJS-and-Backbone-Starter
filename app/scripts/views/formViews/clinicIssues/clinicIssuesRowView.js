define([
	...
	var ClinicIssuesRowView = Backbone.View.extend({
		...
		events: {
			...
			'change select.priority': 'updatePriority',					
		...
		updatePriority: function(ev){
			this.$('select.priority').attr('value',ev.currentTarget.value);
			this.model.set('priority',ev.currentTarget.value);
