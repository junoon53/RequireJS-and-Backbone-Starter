define([
	...
	'models/formModels/treatments/rootCanalRow',
	...
	var RootCanalRowView = Backbone.View.extend({
		...
		className: 'rootCanalRow row-fluid',
		events: {
		...
		addNewTreatment: function(propertyName){
			   var self = this;
				function newTreatmentAdded(treatmentModel) {
     			...
     			vent.trigger('CDF.Views.Treatments.RootCanalRowView:addNewTreatment',{name:propertyName,category:1004,callback:newTreatmentAdded});
		},
		...
		render: function() {
			...
			this.$('.stage').typeahead({source:stagesSource(1004),updater:stagesUpdater,minLength:1,id:"stage"+this.model.cid,map:this.stagesMap});
