define([
	...
	'models/formModels/treatments/perioRow',
		...
		addNewTreatment: function(propertyName){
			   var self = this;
				function newTreatmentAdded(treatmentModel) {
     			...
     			vent.trigger('CDF.Views.Treatments.PerioRowView:addNewTreatment',{name:propertyName,category:1009,callback:newTreatmentAdded});
		},
