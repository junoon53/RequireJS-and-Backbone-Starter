define([
	...
	'vent',
	'text!templates/miscRow.html',
	'text!templates/yesNo.html',
	'config',
	'bootstrap',
	
	], function(Backbone,$,_,utility,Persons,Treatments,MiscRow,vent,template,yesNoTemplate,config){

	var MiscRowView = Backbone.View.extend({
		//model: new MiscRow(),
		className: 'MiscRow row-fluid',
		events: {
		...
		addNewPatient: function(propertyName){
				...
				vent.trigger('CDF.Views.Treatments.MiscRowView:addNewPatient',{patientNameString:propertyName,callback:newPatientAdded});
		},
		addNewDoctor: function(propertyName){
			   var self = this;
				...
				vent.trigger('CDF.Views.Treatments.MiscRowView:addNewDoctor',{doctorNameString:propertyName,callback:newDoctorAdded});
		...
		addNewTreatment: function(propertyName){
			   var self = this;
				function newTreatmentAdded(treatmentModel) {
     			...
     			vent.trigger('CDF.Views.Treatments.MiscRowView:addNewTreatment',{name:propertyName,category:1013,callback:newTreatmentAdded});
		},
		...
		delete: function(ev) {
			...
			vent.trigger('CDF.Views.Treatments.MiscRowView:delete');			
			this.close();
		},
		onValid: function(view,errors){
			var self = this;
			vent.trigger('CDF.Views.Treatments.MiscRowView:onValid');
		...
		render: function() {
			...
			this.$('.treatment').typeahead({source:treatmentsSource(new Treatments(),1013),updater:treatmentsUpdater,minLength:3,id:"treatment"+this.model.cid,map:this.treatmentsMap});
