define([
	...
	], function(Backbone,$,_,Persons,Treatments,ImplantsRow,vent,template,yesNoTemplate){
	...
	var ImplantsRowView = Backbone.View.extend({
		...
		addNewPatient: function(propertyName){
				...
				vent.trigger('CDF.Views.Implants.ImplantsRowView:addNewPatient',{patientNameString:propertyName,callback:newPatientAdded});
		},
		addNewDoctor: function(propertyName){
			   var self = this;
				...
				vent.trigger('CDF.Views.Implants.ImplantsRowView:addNewDoctor',{doctorNameString:propertyName,callback:newDoctorAdded});
		...
		delete: function(ev) {
			...
			vent.trigger('CDF.Views.Implants.ImplantsRowView:delete');			
			this.close();
		},
		onValid: function(view,errors){
			var self = this;
			vent.trigger('CDF.Views.Implants.ImplantsRowView:onValid');
