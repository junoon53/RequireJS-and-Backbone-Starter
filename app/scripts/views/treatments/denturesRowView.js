define([
	...
	var DenturesRowView = Backbone.View.extend({
		...
		addNewPatient: function(propertyName){
				...
				vent.trigger('CDF.Views.Dentures.DenturesRowView:addNewPatient',{patientNameString:propertyName,callback:newPatientAdded});
		},
		addNewDoctor: function(propertyName){
			   var self = this;
				...
				vent.trigger('CDF.Views.Dentures.DenturesRowView:addNewDoctor',{doctorNameString:propertyName,callback:newDoctorAdded});
		...
		delete: function(ev) {
			...
			vent.trigger('CDF.Views.Dentures.DenturesRowView:delete');			
			this.close();
		},
		onValid: function(view,errors){
			var self = this;
			vent.trigger('CDF.Views.Dentures.DenturesRowView:onValid');
