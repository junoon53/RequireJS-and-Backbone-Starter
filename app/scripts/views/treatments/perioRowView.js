define([
	...
	var PerioRowView = Backbone.View.extend({
		...
		addNewPatient: function(propertyName){
				...
				vent.trigger('CDF.Views.Perio.PerioRowView:addNewPatient',{patientNameString:propertyName,callback:newPatientAdded});
		},
		addNewDoctor: function(propertyName){
			   var self = this;
				...
				vent.trigger('CDF.Views.Perio.PerioRowView:addNewDoctor',{doctorNameString:propertyName,callback:newDoctorAdded});
		...
		delete: function(ev) {
			...
			vent.trigger('CDF.Views.Perio.PerioRowView:delete');			
			this.close();
		},
		onValid: function(view,errors){
			var self = this;
			vent.trigger('CDF.Views.Perio.PerioRowView:onValid');
