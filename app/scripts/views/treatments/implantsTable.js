define([
	...
	var ImplantsTableView = Backbone.View.extend({
		...
		initialize: function() {
			...
			this.listenTo(vent,'CDF.Views.Implants.ImplantsRowView:exitColumn:amount', this.updateTotal);
			this.listenTo(vent,'CDF.Views.Implants.ImplantsRowView:onValid', this.updateTotal);

			this.listenTo(vent,'CDF.Views.Implants.ImplantsRowView:delete', this.updateTotal);
